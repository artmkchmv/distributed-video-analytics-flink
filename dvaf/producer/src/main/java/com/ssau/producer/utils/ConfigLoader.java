package com.ssau.producer.utils;
...
public final class ConfigLoader {
    ...
    public static synchronized Properties loadDefault() throws IOException {
        ...
        try {
            Properties localProps = load("producer.local.properties");
            if (localProps != null && !localProps.isEmpty()) {
                return localProps;
            }
        } catch (IOException e) {
            log.debug("producer.local.properties not found, trying producer.properties");
        }
